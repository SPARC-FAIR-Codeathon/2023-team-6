    ...
    <>
      ...
      >
        <div className='form-group row'>
          ...
          >
            This tool will not work without an OpenAI API key. Please include it here.
          </small>
        </div>
        <br />
        <div className='form-group row'>
          ...
          >
            ...
            <option value='machine learning classification modeling'>
              Classification Modeling
            </option>
            <option value='statistical description analysis'>
        ...
        <div className='form-group row'>
          ...
          <small
            style={{ fontSize: '18px' }}
            id='fileTypeHelpBlock'
            className='form-text text-muted'
          >
            What type of file is your data? (e.g. csv, matlab, excel, xml, etc.)
          </small>
        </div>
        <br />
        <div className='form-group row'>
          ...
          <div className='col-sm-9'>
            <input
              ...
              id='packages'
              name='packages'
              placeholder='first-package,second-package'
              onChange={handleChange}
            />
          </div>
          <small
            ...
            className='form-text text-muted'
          >
            Please write each python package you would like to include exactly as written separated
            by a comma
          </small>
        </div>
        <div className='form-group'>
          ...
          <small
            ...
            className='form-text text-muted'
          >
            Please describe your data and optionally provide a short example of your dataset in the
            space above
          </small>
        </div>
        <div className='form-group row'>
